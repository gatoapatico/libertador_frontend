            ...
            <div className="registro-user">
                ...
                <form className="registro-form" >
                    <div className="input-form">
                        ...
                        { isFailEmail ? <p className="txt-fail">Formato de email incorrecto!</p> : "" }
                    </div>
                    <div className="input-form">
                        <input type="password" name="txtContra" placeholder="Password" onChange={(e) => setContrasena(e.target.value)}/>
                        { isFailContrasena ? <p className="txt-fail">Es obligatorio ingresar una contraseña!</p> : "" }
                    </div>
                    <div className="input-form">
                        <input type="text" name="txtDNI" placeholder="Documento de Identidad" onChange={(e) => setDni(e.target.value)}/>
                        { isFailDni ? <p className="txt-fail">El formato de DNI es de 8 digitos!</p> : "" }
                    </div>
                    <div className="input-form">
                        <input type="text" name="txtNombre" placeholder="Nombre" onChange={(e) => setNombre(e.target.value)}/>
                        { isFailNombre ? <p className="txt-fail">El formato de nombre solo acepta letras!</p> : "" }
                    </div>
                    <div className="input-form">
                        <input type="text" name="txtApellido" placeholder="Apellido" onChange={(e) => setApellido(e.target.value)}/>
                        { isFailApellido ? <p className="txt-fail">El formato de apellido solo acepta letras!</p> : "" }
                    </div>
                    <div className="input-form">
                        <input type="text" name="txtTelefono" placeholder="Teléfono" onChange={(e) => setTelefono(e.target.value)}/>
                        { isFailTelefono ? <p className="txt-fail">El formato de telefono es entre 4 y 13 digitos!</p> : "" }
                    </div>
