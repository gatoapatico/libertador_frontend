                    ...
                    <div className="panel panel2">
                        <div className="comprobante-encabezado">
                            <div className="info-encabezado">
                                ...
                                <p className="tarjeta-pedido">Reserva Confirmada: <span className="tarjeta-pedido-codigo">d757978e2c</span> | <span className="tarjeta-pedido-fecha">{dateFormat(reserva.fechaReserva, "dd mmmm yyyy")}</span></p>
                            </div>
